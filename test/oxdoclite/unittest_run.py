...
class TestOxdld(unittest.TestCase):
    def setUp(self):
        """Set up a temporary directory for testing."""
        self.test_dir = "test_oxdld"
        self.doc = Oxdld(self.test_dir)
        self.doc.load_index()
    ...
    def test_set_and_get(self):
        ...
        self.doc.set("test_key", {"field": "value"*10000})
        result = self.doc.get("test_key")
        self.assertEqual(result, {"field": "value"*10000})

    def test_update_value(self):
        """Test updating an existing value."""
        self.doc.set("test_key", {"field": "value"*10000})
        self.doc.set("test_key", {"field": "new_value"*100000})
        result = self.doc.get("test_key")
        self.assertEqual(result, {"field": "new_value"*100000})
